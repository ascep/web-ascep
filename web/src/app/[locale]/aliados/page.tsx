...
export default async function AliadosPage({
  ...
  return (
    <div>
      ...
      <section id="aliados" className="relative overflow-hidden bg-section-light py-16 sm:py-20">
      ...
      <section className="section-dark section-bg-image relative overflow-hidden bg-ley-purple py-16 sm:py-20" style={{ "--section-bg-image": `url(${assetPath(fotos.aliados.hero)})` } as CSSProperties}>
